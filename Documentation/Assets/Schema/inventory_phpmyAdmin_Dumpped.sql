...
ALTER TABLE `roleaccess`
  ...
  ADD CONSTRAINT `RoleAccess_FK_Roles_RoleId` FOREIGN KEY (`RoleId`) REFERENCES `roles` (`RoleId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `RoleAccess_FK_UserGroup_GroupId` FOREIGN KEY (`GroupId`) REFERENCES `usergroup` (`GroupId`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `sales`
  ...
  ADD CONSTRAINT `Sales_FK_Product_ProductId` FOREIGN KEY (`ProductId`) REFERENCES `product` (`ProductId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Sales_FK_Users_UserId` FOREIGN KEY (`UserId`) REFERENCES `users` (`UserId`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `warehouseandmartproducts`
  ...
  ADD CONSTRAINT `WarehouseAndMartProducts_FK_WarehouseAndMart_WMId` FOREIGN KEY (`WMId`) REFERENCES `warehouseandmart` (`WMId`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
