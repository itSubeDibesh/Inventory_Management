addEventListener('DOMContentLoaded',()=>{
    const Session = window.sessionStorage,
        sessionKey = {id:Session.getItem("id"), phone:Session.getItem("phone"), email:Session.getItem("email"), avatar:Session.getItem("avatar"), getImagePath:Session.getItem("getImagePath"), userName:Session.getItem("userName")};
